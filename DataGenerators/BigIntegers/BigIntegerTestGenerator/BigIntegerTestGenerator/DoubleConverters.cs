// Copied from http://www.yoda.arachsys.com/csharp/DoubleConverter.cs
// See http://csharpindepth.com/Articles/General/FloatingPoint.aspx
//
// Copyright John Skeet.
    ...
    public class DoubleConverter
    {
        ...
        public static string ToExactString (double d)
        {
            if (double.IsPositiveInfinity(d))
                ...
                return SpecialValues[1];
            else if (double.IsNaN(d))
                return SpecialValues[2];
